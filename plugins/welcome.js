...
module.exports = {
  ...
  intro: function(msg) {
    return msg.send("Всем привет! Я очень умный, и могу делать много разных вещей. Введите /help, чтобы посмотреть список команд.");
  },
  welcomeUser: function(msg, user) {
    return msg.send("Добро пожаловать в Chatroom. Друзья, знакомимся с " + user.first_name + "!");
  }
};
